...
export default function ArtifactManagement() {
  ...
  const handleSave = async () => {
    ...
    const url = editingArtifact
      ? `${API_URL}/artifacts/${editingArtifact._id}`
      : `${API_URL}/artifacts`;
  ...
  const deleteArtifact = (id) => {
    Alert.alert("Delete Artifact", "Are you sure?", [
      { text: "Cancel" },
      {
        ...
        onPress: async () => {
          const token = await getAuthToken();
          await fetch(`${API_URL}/artifacts/${id}`, {
            method: "DELETE",
  ...
  const openEdit = (artifact) => {
    ...
    setFormData({
      ...
      museum: artifact.museum?._id || artifact.museum,
      era: artifact.era,
    });
    setModalVisible(true);
  };
    ...
    <View style={styles.card}>
      <View style={styles.cardInfo}>
        ...
        <Text style={styles.sub}>
          {item.era} • {item.museum?.name || "No Museum"}
        </Text>
      </View>
      <View style={styles.actions}>
        ...
        <TouchableOpacity onPress={() => deleteArtifact(item._id)}>
          <MaterialCommunityIcons
          ...
          <View style={styles.modalContent}>
            ...
            <ScrollView>
              ...
              <Text style={styles.hint}>
                Tip: Use IDs from Museum management for now.
              </Text>
              <TextInput
